...
import static com.zrs.yuh.rs.R.drawable.course_info_2;

public class CourseTableView extends RelativeLayout {
    // 课程格子的背景图
    private static final int[] COURSE_BG = {
            course_info_2,R.drawable.course_info_4,R.drawable.course_info_3,
            R.drawable.course_info_13,R.drawable.course_info_1,R.drawable.course_info_6,
            R.drawable.course_info_7,R.drawable.course_info_8,R.drawable.course_info_9,
            R.drawable.course_info_10,R.drawable.course_info_11,R.drawable.course_info_12,
            R.drawable.course_info_5,R.drawable.course_info_14,R.drawable.course_info_15,
    };
    ...
    public void updateCourseViews(List<? extends Course> coursesData,Activity activity) {
    ...
    private void updateCourseViews() {
        ...
        for (final Course c : coursesData) {
            ...
            tv.setLines(10);
            tv.setBackgroundResource(COURSE_BG[c.getCourseColor()%COURSE_BG.length]);
    ...
    public void showCouseDetails(Course course , Activity activity) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);

        String type_text = "学分：" + course.getClassTypeName();
        String teacher_text = "授课教师：" + course.getClassTeacherName();
